...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['10 devices', '1,000 events/hr', '3 edge rules', 'Community support'] },
  { name: 'Pro', price: '$59/mo', features: ['500 devices', '50,000 events/hr', 'Unlimited rules', 'Alert webhooks', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited devices', 'On-prem edge nodes', 'Custom protocols', 'SLA guarantee', 'Dedicated support'] },
];
